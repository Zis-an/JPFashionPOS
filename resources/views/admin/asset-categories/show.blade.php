    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin.asset-categories.index')}}">Asset Categories</a></li>
            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" class="form-control" placeholder="Enter category name" value="{{ $category->name ?? '' }}" readonly>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('admin.asset-categories.destroy', $category->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <a href="{{ route('admin.asset-categories.index') }}" class="btn btn-success" >Go Back</a>
                            @can('asset-categories.update')
                                <a href="{{ route('admin.asset-categories.edit',['asset_category'=>$category->id]) }}" class="btn btn-warning ">
