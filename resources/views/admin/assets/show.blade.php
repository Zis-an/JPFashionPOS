...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Asset - {{ $asset->name }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.assets.index')}}">Asset</a></li>
                        ...
                        @endif
                            <table class="table table-bordered w-100 text-left">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $asset->amount ?? '' }} BDT</td>
                                </tr>
                                <tr>
                                    <th style="width: 30%;">Details</th>
                                    <td>{{ strip_tags($asset->details) ?? '' }}</td>
                                </tr>
                                <tr>
                            ...
                            <div class="my-3">
                                <legend>Asset's Photos</legend>
                            </div>
                            <div id="image-preview-container" class="form-group mb-2 d-flex flex-wrap">
                                @if($asset->images)
                                    <img src="{{ asset($asset->images) }}" alt="Expense Photo" class="selected-image">
                                @else
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col-md-12">
                                    ...
                                    @if($activities->isEmpty())
                                        <p>No activities found for this asset.</p>
                                    @else
