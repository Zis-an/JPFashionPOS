...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Currency - {{ $currency->name }}</h1>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="code" name="code" value="{{ $currency->code ?? '' }}" class="form-control" placeholder="Enter code" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" value="{{ $currency->name ?? '' }}" class="form-control" placeholder="Enter name" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="rate" value="{{ $currency->rate ?? '' }}" name="rate" class="form-control"
                        ...
                        <form action="{{ route('admin.currencies.destroy', $currency->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <a href="{{ route('admin.currencies.index') }}" class="btn btn-success" >Go Back</a>
                            @can('currencies.update')
                                <a href="{{ route('admin.currencies.edit',['currency'=>$currency->id]) }}" class="btn btn-warning ">
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col-md-12">
                                    ...
                                    @if($activities->isEmpty())
                                        <p>No activities found for this Currency.</p>
                                    @else
