...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.materials.update', $material->id) }}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @csrf
                        @method('PUT')
                        @if ($errors->any())
                        ...
                        <div class="row">
                                    ...
                                    <select id="raw_material_category_id" name="raw_material_category_id" class="form-control select2">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ $material->raw_material_category_id == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="old_photo" value="{{ getAssetUrl($material->image, $material->name) }}" class="d-none">
                                    <input name="photo" type="file" class="form-control" id="photo">
                                </div>
                                <div class="form-group mb-2">
                                    <img src="{{ getAssetUrl($material->image, $material->name) }}" alt="Selected Image" id="selected-image">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" name="details" class="form-control" rows="4">{{ $material->details }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="width" name="width" type="number" step="0.01" class="form-control"
                                           placeholder="Enter width" value="{{ $material->width }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="length" name="length" type="number" step="0.01" class="form-control"
                                           placeholder="Enter length" value="{{ $material->length }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="density" name="density" type="number" step="0.01"
                                           class="form-control" placeholder="Enter density" value="{{ $material->density }}">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function displayExistingPhoto() {
                const existingPhotoUrl = '{{ getAssetUrl($material->image, $material->name) }}';
                if (existingPhotoUrl) {
