...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Departments - {{ $department->name }}</h1>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <form action="{{ route('admin.departments.destroy', $department->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <a href="{{ route('admin.departments.index') }}" class="btn btn-success" >Go Back</a>
                            @can('departments.update')
                                <a href="{{ route('admin.departments.edit',['department'=>$department->id]) }}" class="btn btn-warning ">
...
@section('js')
    <script>
        function isDelete(button) {
            ...
            Swal.fire({
                title: @json(__('Delete Department')),
