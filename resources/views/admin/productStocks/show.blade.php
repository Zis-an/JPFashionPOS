...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Stock - {{ $stock->name }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.product-stocks.index') }}">Product Stocks</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        @endif
                        <table class="table table-bordered w-100 text-left mb-2">
                            <tr>
                        ...
                        <form action="{{ route('admin.product-stocks.destroy', $stock->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <a href="{{ route('admin.product-stocks.index') }}" class="btn btn-success" >Go Back</a>
                        </form>
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col-md-12">
                                    ...
                                    @if($activities->isEmpty())
                                        <p>No activities found for this stock.</p>
                                    @else
