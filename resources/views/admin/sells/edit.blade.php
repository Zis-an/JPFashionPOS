    ...
    <script>
        $(document).ready(function() {
            ...
            existingProductsArray.forEach(item => {
                existingProducts[item.product_id] = {
                    id: item.id,
                    name: `Product ${item.product_id}`,  // Modify as needed to retrieve name
                    price: item.price || 0,
                    quantity: item.quantity || 0,
                    maxQuantity: item.quantity || 0,  // Assuming max quantity is the same as available quantity
            ...
            function createProductCard(product, price, quantity) {
                ...
                <div class="card text-center product-card" style="border: none;"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style="font-size: 10px; margin: 0;">Quantity: ${quantity}</p>
                        <p class="card-text" style="font-size: 10px; margin: 0;">Price: ${price}</p>
                    </div>
                </div>`;
            }
