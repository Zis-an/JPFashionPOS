...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.rawMaterialPurchases.update', $purchase->id) }}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @csrf
                                        ...
                                        <tbody>
                                            @foreach($products as $product)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" name="price[]" value="{{ $product->pivot->price }}" class="form-control price-input form-control-sm"
