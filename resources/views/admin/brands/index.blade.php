...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Brands</h1>
            @can('brands.create')
                <a href="{{ route('admin.brands.create') }}" class="btn btn-primary mt-2">Add new</a>
            @endcan
            @can('brands.trashed')
                <a href="{{ route('admin.brands.trashed') }}" class="btn btn-danger mt-2">Trash List</a>
            @endcan
