...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Warehouse - {{ $warehouse->name }}</h1>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.warehouses.destroy', $warehouse->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{ route('admin.warehouses.index') }}" class="btn btn-success">Go Back</a>
                        @can('warehouses.update')
                            <a href="{{ route('admin.warehouses.edit', ['warehouse' => $warehouse->id]) }}" class="btn btn-warning"><i class="fa fa-pen"></i> Edit</a>
                        @endcan
                    ...
                    <div class="row mt-4 mb-4">
                        <div class="col-md-12">
                            ...
                            @if($activities->isEmpty())
                                <p>No activities found for this warehouse.</p>
                            @else
