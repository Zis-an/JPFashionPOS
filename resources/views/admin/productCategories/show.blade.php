    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin.productCategories.index')}}">Product Categories</a></li>
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <form action="{{ route('admin.productCategories.destroy', $category->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <a href="{{ route('admin.productCategories.index') }}" class="btn btn-success" >Go Back</a>
                            @can('productCategories.update')
                                <a href="{{ route('admin.productCategories.edit',['productCategory'=>$category->id]) }}" class="btn btn-warning ">
...
@section('js')
    <script>
        function isDelete(button) {
            ...
            Swal.fire({
                title: @json(__('Delete Product Category')),
