...
@section('title', 'View Production House Payment')
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Production House Payment - {{ $payment->productionHouse->name }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.production-payments.index')}}">Production House Payments</a></li>
                <li class="breadcrumb-item active">View Production House Payment</li>
            </ol>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered w-100 text-left">
                        ...
                        <tr>
                            ...
                            <td>{{ strip_tags($payment->details) ?? '' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>{{ strip_tags($payment->received_by) ?? '' }}</td>
                        </tr>
                        <tr>
                    ...
                    <div class="my-3">
                        <legend>Production House Payment's Photos</legend>
                    </div>
                    <div id="image-preview-container" class="form-group mb-2 d-flex flex-wrap">
                        @if($payment->image)
                            <img src="{{ asset($payment->image) }}" alt="Payment Photo" class="selected-image">
                        @else
                    ...
                    <form action="{{ route('admin.production-payments.destroy', $payment->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{route('admin.production-payments.index')}}" class="btn btn-success" >Go Back</a>
                        @can('productionPayments.update')
                            <a href="{{route('admin.production-payments.edit',['production_payment'=>$payment->id])}}" class="btn btn-warning ">
