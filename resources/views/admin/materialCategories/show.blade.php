...
@section('title', 'View Raw Material Category')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.materialCategories.destroy', $category->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{ route('admin.materialCategories.index') }}" class="btn btn-success">Go Back</a>
                        @can('materialCategories.update')
                            <a href="{{ route('admin.materialCategories.edit', ['materialCategory' => $category->id]) }}" class="btn btn-warning">
