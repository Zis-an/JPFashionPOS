...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Supplier Payment - {{ $payment->supplier->name }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.supplier-payments.index')}}">Supplier Payments</a></li>
                <li class="breadcrumb-item active">View Supplier Payment</li>
            </ol>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="my-3">
                        <legend>Supplier Payment's Photos</legend>
                    </div>
                    ...
                    <form action="{{ route('admin.supplier-payments.destroy', $payment->id) }}" method="POST">
                        ...
                        @can('supplierPayments.update')
                            <a href="{{route('admin.supplier-payments.edit',['supplier_payment'=>$payment->id])}}" class="btn btn-warning ">
