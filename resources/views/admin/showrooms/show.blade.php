...
@section('title', 'View Showroom')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Showroom - {{ $showroom->name }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.showrooms.index') }}">Showrooms</a></li>
                <li class="breadcrumb-item active">View Showroom</li>
            </ol>
        </div>
    </div>
@stop
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.showrooms.destroy', $showroom->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{ route('admin.showrooms.index') }}" class="btn btn-success">Go Back</a>
                        @can('showrooms.update')
                            <a href="{{ route('admin.showrooms.edit', ['showroom' => $showroom->id]) }}" class="btn btn-warning"><i class="fa fa-pen"></i> Edit</a>
                        @endcan
                    ...
                    <div class="row mt-4 mb-4">
                        <div class="col-md-12">
                            ...
                            @if($activities->isEmpty())
                                <p>No activities found for this showroom.</p>
                            @else
