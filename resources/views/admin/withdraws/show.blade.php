...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Withdraw - {{ $withdraw->account->name }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.withdraws.index')}}">Withdraws</a></li>
                <li class="breadcrumb-item active">View Withdraw</li>
            </ol>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered w-100 text-left">
                        ...
                        <tr>
                            ...
                            <td>{{ strip_tags($withdraw->notes) ?? '' }}</td>
                        </tr>
                        <tr>
                    ...
                    <div class="my-3">
                        <legend>Withdraw's Photos</legend>
                    </div>
                    <div id="image-preview-container" class="form-group mb-2 d-flex flex-wrap">
                        @if($withdraw->image)
                            <img src="{{ asset($withdraw->image) }}" alt="Withdraw Photo" class="selected-image">
                        @else
                    ...
                    <form action="{{ route('admin.withdraws.destroy', $withdraw->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <a href="{{route('admin.withdraws.index')}}" class="btn btn-success" >Go Back</a>
                        @can('withdraws.update')
                            <a href="{{route('admin.withdraws.edit',['withdraw'=>$withdraw->id])}}" class="btn btn-warning "><i class="fa fa-pen"></i> Edit</a>
                        @endcan
                    ...
                    <div class="row mt-4 mb-4">
                        <div class="col-md-12">
                            ...
                            @if($activities->isEmpty())
                                <p>No activities found for this Withdraw.</p>
                            @else
