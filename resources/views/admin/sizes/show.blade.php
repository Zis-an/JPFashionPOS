            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <form action="{{ route('admin.sizes.destroy', $size->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <a href="{{route('admin.sizes.index')}}" class="btn btn-success" >Go Back</a>
                            @can('sizes.update')
                                <a href="{{route('admin.sizes.edit',['size'=>$size->id])}}" class="btn btn-warning "><i class="fa fa-pen"></i> Edit</a>
                            @endcan
                            @can('sizes.delete')
