                ...
                <div class="card-body">
                        ...
                        @endif
                            <table class="table table-bordered w-100 text-left mb-3">
                                <tr>
                                    <th style="width: 30%;">Color Code</th>
                        ...
                        <form action="{{ route('admin.colors.destroy', $color->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <a href="{{route('admin.colors.index')}}" class="btn btn-success" >Go Back</a>
                            @can('colors.update')
                                <a href="{{route('admin.colors.edit',['color'=>$color->id])}}" class="btn btn-warning "><i class="fa fa-pen"></i> Edit</a>
                            @endcan
                            @can('colors.delete')
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col-md-12">
                                    ...
                                    @if($activities->isEmpty())
                                        <p>No activities found for this color.</p>
                                    @else
