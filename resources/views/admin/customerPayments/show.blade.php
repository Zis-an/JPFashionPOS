...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>View Customer Payment - {{ $payment->customer->name }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.customer-payments.index')}}">Customer Payments</a></li>
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <form action="{{ route('admin.customer-payments.destroy', $payment->id) }}" method="POST">
                            @method('DELETE')
                            @csrf
                            <a href="{{route('admin.customer-payments.index')}}" class="btn btn-success" >Go Back</a>
                            @can('customerPayments.update')
                                <a href="{{route('admin.customer-payments.edit',['customer_payment'=>$payment->id])}}" class="btn btn-warning ">
