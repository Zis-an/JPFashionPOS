...
@section('title', 'Update Customer Payment')
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Update Customer Payment</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.customer-payments.index') }}">Customer Payments</a></li>
                <li class="breadcrumb-item active">Update Customer Payment</li>
            </ol>
        </div>
    </div>
@stop
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.customer-payments.update',['customer_payment'=>$payment->id]) }}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @method('PUT')
                        @csrf
                        @if (count($errors) > 0)
...
<script>
    $(document).ready(function() {
        ...
        function displayExistingPhoto() {
            const existingPhotoUrl = '{{ asset($payment->image) }}';
            if (existingPhotoUrl) {
