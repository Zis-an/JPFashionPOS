        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'label_color' => 'success',
                    'can' => ['customerPayments.list','customerPayments.create','customerPayments.update','customerPayments.delete', 'customerPayments.restore',
                ...
                [
                    ...
                    'url' => 'admin/production-payments',
                    'icon' => 'fas fa-campground custom-icon-class',
                    'label_color' => 'success',
                    'can' => ['productionPayments.list','productionPayments.create','productionPayments.update','productionPayments.delete',
                        'productionPayments.restore', 'productionPayments.force_delete', 'productionPayments.trashed', 'productionPayments.activity'],
                ],
                [
